      ...
      <div className="flex justify-center items-center mt-12">
        <div className="relative rounded-full w-[270px] sm:w-[470px] border border-gray-300 px-4 py-3">
          ...
          <button
            ...
            className="hidden sm:absolute inset-y-0 right-0 sm:flex justify-center items-center p-5 gap-[10px] bg-pinkBtn hover:bg-[#b6276e] text-white rounded-full capitalize mb-1 mt-1 mr-1"
          >
            join us
          </button>
        </div>
